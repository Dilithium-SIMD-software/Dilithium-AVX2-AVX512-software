...
rej:
  ...
  polyveck w0prime;
  if(evaluate_cs1_cs2_early_check_32_AVX512(&z, &w0prime, &cp, s1_table, s2_table, &y, &w0, GAMMA1 - BETA, GAMMA2 - BETA))
  {
    goto rej;
  }
...
{
  unsigned int i;
  uint8_t buf[K*POLYW1_PACKEDBYTES+16];
