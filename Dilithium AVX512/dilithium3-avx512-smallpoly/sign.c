...
rej:
  ...
  int i;
  polyveck w0prime;
  if(evaluate_cs2_earlycheck_32_avx512(&w0prime, &w0, &cp, s21_table, s22_table, GAMMA2 - BETA))
  {
    goto rej;
  }
  if(evaluate_cs1_earlycheck_32_avx512(&z, &y, &cp, s11_table, s12_table, GAMMA1 - BETA))
  {
    goto rej;
  }
